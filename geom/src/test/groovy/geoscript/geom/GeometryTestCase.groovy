...
class GeometryTestCase {
    ...
    @Test void getWkb() {
        ...
        Assert.assertArrayEquals([0, 0, 0, 0, 1, 64, 91, -64, 0, 0, 0, 0, 0, -64, 71, -128, 0, 0, 0, 0, 0] as byte[], g.wkbBytes)
    }
    ...
    @Test void getDimension() {
        Assert.assertEquals 0, Geometry.fromWKT("POINT (1 1)").dimension
        Assert.assertEquals 1, Geometry.fromWKT("LINESTRING (1 1, 10 10)").dimension
        Assert.assertEquals 2, Geometry.fromWKT("POLYGON ((90 90, 90 110, 110 110, 110 90, 90 90))").dimension
    }
