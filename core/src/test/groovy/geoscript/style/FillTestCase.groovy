...
class FillTestCase {
    ...
    @Test void randomizedFill() {
        ...
        layer.style = (new Fill(null).hatch("circle", new Fill("#aaaaaa"), 1).random([random:"free", symbolCount: "50", tileSize: "100"]).where("PERSONS < 2000000")) +
        ...
        Draw.draw(layer, out: file, backgroundColor: "white")
