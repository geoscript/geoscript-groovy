...
class GeoRSSWriterTestCase {
    ...
    @Test void writeAtomW3C() {
        ...
        String expected = "<entry  ><title>house1</title><summary>[geom:POINT (111 -47), name:House, price:12.5]</summary>" +
                "<updated>12/7/2013</updated><geo:Point><geo:lat>-47.0</geo:lat><geo:long>111.0</geo:long></geo:Point></entry>"
    ...
    @Test void writeRssSimple() {
        ...
        String expected = "<item ><pubDate>12/7/2013</pubDate><title>house1</title>" +
                "<description>[geom:POINT (111 -47), name:House, price:12.5]</description>" +
                "<georss:point>-47.0 111.0</georss:point></item>"
        String actual = writer.write(feature)
        AssertUtil.assertStringsEqual expected, actual, removeXmlNS: true
    }
    ...
    @Test void writeRssGml() {
        ...
        String expected = "<item  ><pubDate>12/7/2013</pubDate><title>house1</title>" +
                "<description>[geom:POINT (111 -47), name:House, price:12.5]</description>" +
                "<georss:where><gml:Point><gml:pos>-47.0 111.0</gml:pos></gml:Point></georss:where></item>"
        String actual = writer.write(feature)
        AssertUtil.assertStringsEqual expected, actual, removeXmlNS: true
    }
    ...
    @Test void writeRssW3C() {
        ...
        String expected = "<item ><pubDate>12/7/2013</pubDate><title>house1</title>" +
                "<description>[geom:POINT (111 -47), name:House, price:12.5]</description>" +
                "<geo:Point><geo:lat>-47.0</geo:lat><geo:long>111.0</geo:long></geo:Point></item>"
        String actual = writer.write(feature)
        AssertUtil.assertStringsEqual expected, actual, removeXmlNS: true
    }
}
