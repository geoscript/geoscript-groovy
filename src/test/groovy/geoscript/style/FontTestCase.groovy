...
class FontTestCase {
    ...
    @Test void constructors() {
        ...
        // Default constructor
        Font font = new Font()
        assertEquals "normal", font.style
        assertEquals "normal", font.weight
        assertEquals 10, font.size
        ...
        assertEquals "italic", font.style
        assertEquals "bold", font.weight
        assertEquals 12, font.size
        assertEquals "Verdana", font.family
