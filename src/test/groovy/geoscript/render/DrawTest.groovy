...
class DrawTest {
    ...
    @Test void drawGeometry() {
        ...
        File file = new File(folder,"draw_geometry.png")
    ...
    @Test void drawGeometries() {
        ...
        File file = new File(folder,"draw_geometries.png")
    ...
    @Test void drawFeature() {
        ...
        Symbolizer sym = new Stroke('navy', 0.1)
        File file = new File(folder,"draw_feature.png")
    ...
    @Test void drawLayer() {
        ...
        layer.style = sym
        File file = new File(folder,"draw_layer.png")
    ...
    @Test void drawRaster() {
        ...
        File file = new File(folder,"draw_raster.png")
    ...
    @Test void drawLayerToPdf() {
        ...
        Layer layer = new Shapefile(shpFile)
        layer.style = sym
        File file = new File(folder,"draw_layer.pdf")
