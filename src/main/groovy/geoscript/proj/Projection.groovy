...
class Projection {
    ...
    private static final Map wellKnownProjections = [
            ...
            "EqualEarth": 'PROJCS["Equal Earth",GEOGCS["GCS_WGS_1984",DATUM["D_WGS_1984",SPHEROID["WGS_1984",6378137.0,298.257223563]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]],PROJECTION["Equal Earth"],PARAMETER["Central_Meridian",0.0],UNIT["Meter",1.0]]',
            ...
            "WinkelTripel": 'PROJCS["WinkeTripel", GEOGCS["WGS84",  DATUM["WGS84",  SPHEROID["WGS84",  6378137.0, 298.257223563]], PRIMEM["Greenwich", 0.0], UNIT["degree",0.017453292519943295], AXIS["Longitude",EAST], AXIS["Latitude",NORTH]], PROJECTION["Winkel Tripel"], UNIT["m", 1.0], AXIS["Easting", EAST], AXIS["Northing", NORTH]]',
